...
; Date ..........: 2019/08/11
; Version .......: 2.1.16 BETA - Work in progress
; ================================================================================
...
#cs
	...
	__ADO_ComErrorHandler_InternalFunction(ByRef $oCOMError)
	_ADO_COMErrorHandler(ByRef $oADO_Error)
...
#ce
#EndRegion ADO.au3 - Function INDEX
...
; Return values .: Success - $ADO_RET_SUCCESS
;                  Failure - $ADO_RET_FAILURE, and sets @error .....
; Author ........: mLipok
; Modified ......:
...
;~ 		$oConnection.Properties("Password") = $sPassword
	...
	While Sleep(10)
		; @TODO possibilty to: interact with long-lasting loop / interrupting waiting
...
; Example .......: no
; ================================================================================
Func _ADO_COMErrorHandler(ByRef $oADO_Error)
	If @Compiled Then Return SetError($ADO_ERR_SUCCESS, $ADO_EXT_DEFAULT, $ADO_RET_SUCCESS)
...
Func _ADO_OpenSchema_Catalogs(ByRef $oConnection, $s_CATALOG_NAME = Default)
	...
	Return SetError($ADO_ERR_SUCCESS, $ADO_EXT_DEFAULT, $oRecordset_catalogs)
...
Func _ADO_OpenSchema_Columns(ByRef $oConnection, $s_TABLE_CATALOG = Default, $s_TABLE_SCHEMA = Default, $s_TABLE_NAME = Default, $s_COLUMN_NAME = Default)
	...
	Return SetError($ADO_ERR_SUCCESS, $ADO_EXT_DEFAULT, $oRecordset_columns)
...
Func _ADO_OpenSchema_Indexes(ByRef $oConnection, $s_TABLE_CATALOG = Default, $s_TABLE_SCHEMA = Default, $s_INDEX_NAME = Default, $s_TYPE = Default, $s_TABLE_NAME = Default)
	...
	Return SetError($ADO_ERR_SUCCESS, $ADO_EXT_DEFAULT, $oRecordset_Indexes)
...
Func _ADO_OpenSchema_Procedures(ByRef $oConnection, $s_PROCEDURE_CATALOG = Default, $s_PROCEDURE_SCHEMA = Default, $s_PROCEDURE_NAME = Default, $s_PARAMETER_NAME = Default)
	...
	Local $oRecordset_procedures = $oConnection.OpenSchema($ADO_adSchemaProcedureParameters, $aCriteria_Procedure)
	If @error Then Return SetError($ADO_ERR_COMERROR, @error, $ADO_RET_FAILURE)

	Return SetError($ADO_ERR_SUCCESS, $ADO_EXT_DEFAULT, $oRecordset_procedures)
...
Func _ADO_OpenSchema_Tables(ByRef $oConnection, $s_TABLE_CATALOG = Default, $s_TABLE_SCHEMA = Default, $s_TABLE_NAME = Default, $s_TABLE_TYPE = Default)
	...
	Return SetError($ADO_ERR_SUCCESS, $ADO_EXT_DEFAULT, $oRecordset_tables)
...
Func _ADO_Schema_GetAllTables(ByRef $oConnection, $s_TABLE_CATALOG)
	Local $oRecordset_tables = _ADO_OpenSchema_Tables($oConnection, $s_TABLE_CATALOG)
	If @error Then Return SetError(@error, @extended, $ADO_RET_FAILURE)

	Local $aSchema_Tables = _ADO_Recordset_ToArray($oRecordset_tables)
	If @error Then Return SetError(@error, @extended, $ADO_RET_FAILURE)
